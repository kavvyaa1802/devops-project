...
public class HelloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        out.println(".info-row{display:flex;justify-content:space-between;padding:12px 0;border-bottom:1px solid #334155;color:#e2e8f0;}");
        ...
        out.println("<div class='info-row'><span class='info-label'>Message</span><span class='info-value'>Hello from Jenkins CI/CD Pipeline!</span></div>");
        out.println("<div class='info-row'><span class='info-label'>Build Version</span><span class='info-value'>" + BUILD_VERSION + "</span></div>");
        out.println("<div class='info-row'><span class='info-label'>Pipeline</span><span class='info-value'>" + PIPELINE + "</span></div>");
        out.println("<div class='info-row'><span class='info-label'>Timestamp</span><span class='info-value'>" + time + "</span></div>");
        out.println("<div class='info-row'><span class='info-label'>Client IP</span><span class='info-value'>" + req.getRemoteAddr() + "</span></div>");
        out.println("</div>");
